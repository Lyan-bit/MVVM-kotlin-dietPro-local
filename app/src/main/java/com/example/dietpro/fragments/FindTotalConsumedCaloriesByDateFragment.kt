...
import com.example.dietpro.usecase.FindTotalConsumedCaloriesByDateBean
...
class FindTotalConsumedCaloriesByDateFragment : Fragment(), View.OnClickListener , AdapterView.OnItemSelectedListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
		...
		findTotalConsumedCaloriesByDatemealsListItems = model.allMealids()
		...
		findTotalConsumedCaloriesByDateuserListItems = modelUser.allUserUserNames()
